function K = covMaternard_modified(d, hyp, x, z, i)

% fixed for errors in derivatives
% modified to change division by lengthscale to multiplication by it, so
% that lengthscale can be equal zero
