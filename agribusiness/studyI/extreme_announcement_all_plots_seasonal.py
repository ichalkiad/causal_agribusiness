        ...
        for contract in ["front", "second"]:
            ...
            for period in ["planting", "harvest", "grow", "rest"]:
                ...
                for i in index2use:
                    ...
                    # usda         
                    vals_usda = np.diff(sentiment_clean2.loc[indexrange, "usdacmecftc"].values)
                    if vals_usda[0] == 0:
                        continue
                ...
                if np.any(np.isnan(allusda)) or np.any(np.isnan(allcustom)):
                    print("Check!")
                ...
                savename = "{}/sentiment_aroundallreports_seasonal_smooth{}_May2024/announcesentiment_{}_{}_{}_{}_usdacmecftc_size{}.html".format(DIR_out, smooth, top, contract, period, timescale, allusda.shape[0])
                ...
                fix_plot_layout_and_save(fig_usda, savename, xaxis_title="Event window ({})".format(timescale), 
                                        ...
                                        print_png=True)
                savename = "{}/sentiment_aroundallreports_seasonal_smooth{}_May2024/announcesentiment_{}_{}_{}_{}_customdict_size{}.html".format(DIR_out, smooth, top, contract, period, timescale, allusda.shape[0])                
